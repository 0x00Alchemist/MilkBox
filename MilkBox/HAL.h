...
/**
 * \note @0x00Alchemist: 
 * Technically, the Windows loader and the HAL itself stores all runtime services, 
...
typedef struct _HAL_EFI_RUNTIME_SERVICES_BLOCK {
	...
	SIZE_T                         ValueOfBlocks; // \note @0x00Alchemist: need more researches, maybe, it's just a size of block
} HAL_EFI_RUNTIME_SERVICES_BLOCK, *PHAL_EFI_RUNTIME_SERVICES_BLOCK;

/**
 * \note @0x00Alchemist: 
 * The HAL_IUM_EFI_WRAPPER_TABLE structure is located right after the HAL_EFI_RUNTIME_SERVICES_BLOCK structure 
